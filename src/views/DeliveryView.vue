        ...
        <div class="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div v-reveal>
            ...
            <h1 class="section-title text-3xl sm:text-4xl lg:text-5xl leading-tight">
              Доставка и заявка по Астане и Казахстану.
            </h1>
            <p class="section-lead mt-5 max-w-xl text-sm sm:text-base">
              Укажите город, нужные позиции и количество. После уточнения габаритов, веса и наличия элементов согласуем способ и стоимость доставки.
            </p>
            ...
            <div class="grid gap-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
              <div>
                ...
                <p class="section-lead mt-4 text-sm sm:text-base">
                  Стоимость и сроки зависят от города, габаритов и состава заказа. Уточним эти условия до оплаты.
                </p>
              </div>
...
const faq = [
  ...
  },
  {
    ...
    a: 'Оплата производится через Kaspi после подтверждения наличия, количества и доставки. Сначала отправьте выбранные позиции, размеры и город, чтобы согласовать заказ.',
  },
]
</script>
