...
assert.match(productView, /decoding="async"[\s\S]*sizes="\(min-width: 1024px\) 50vw, 100vw"/)
assert.match(productCard, /decoding="async"[\s\S]*sizes="\(min-width: 1280px\) 25vw, \(min-width: 768px\) 33vw, 100vw"/)
assert.match(appHeader, /decoding="async" sizes="48px"/)
