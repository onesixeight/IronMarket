<template>
  <div>
    ...
    <section class="py-20 bg-obsidian-800 relative overflow-hidden">
      <div class="diagonal-lines absolute inset-0 opacity-[0.02]"></div>
      <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="max-w-3xl mx-auto space-y-6 text-cream-100/70 text-[15px] leading-relaxed" v-reveal>
          <p>
            Мы не являемся производителем. Наша задача — собрать сильный ассортимент кованых элементов, помочь с выбором и предложить понятную поставку для частных заказчиков и монтажников.
          </p>
          <p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            <div class="w-14 h-14 bg-gradient-to-br from-gold-400/20 to-gold-600/10 border border-gold-400/30 rounded-2xl flex items-center justify-center mx-auto mb-6 transition-all duration-300 group-hover:shadow-lg group-hover:shadow-gold-500/20 group-hover:scale-110">
              <span class="text-gold-400"><component :is="v.icon" /></span>
            </div>
...
const IconReliability = () => h('svg', { class: 'w-6 h-6', fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24', 'stroke-width': '1.5' }, [
  h('path', { 'stroke-linecap': 'round', 'stroke-linejoin': 'round', d: 'M11.42 15.17l-5.1-5.1m0 0L11.42 4.97m-5.1 5.1H21' })
])
const IconPerson = () => h('svg', { class: 'w-6 h-6', fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24', 'stroke-width': '1.5' }, [
